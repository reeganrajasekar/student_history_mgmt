            ...
            <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                        ...
                        if(isset($_GET["reg"])){
                            $reg=$_GET["reg"];
                            $sql = "SELECT * FROM student WHERE reg='$reg' order by reg ASC";
                        }else{
                            $sql = "SELECT * FROM student WHERE dept='$dept' AND sem='$sem' order by reg ASC";
                        }
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="/staff/record.php?id=<?php echo($row['id']) ?>" class="border rounded p-2 text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                    View
                                </a>
                            </td>
                        </tr>
