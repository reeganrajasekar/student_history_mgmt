<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="" >
      ...
      <span class="ms-1 font-weight-bold">SJCET_TNJ</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link <?php if($_SERVER['PHP_SELF'] == '/staff/home.php'){ echo 'active'; } ?>" href="/staff/home.php">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($_SERVER['PHP_SELF'] == '/staff/student.php' || $_SERVER['PHP_SELF'] == '/staff/record.php'){ echo 'active'; } ?>" href="/staff/student.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($_SERVER['PHP_SELF'] == '/staff/attendance.php'){ echo 'active'; } ?>" href="/staff/attendance.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <ul class="navbar-nav " style="justify-content:space-between;">
        ...
        <li class="nav-item dropdown pe-2 d-flex align-items-center">
          ...
          <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
            <li >
              <p class="text-center text-primary"><?php echo($_SESSION["sname"]) ?></p>
            </li>
            <li >
              <a class="dropdown-item border-radius-md" href="/staff/logout.php">
                Logout
              </a>
            </li>
          </ul>
